defmodule Ashworld.ShoppingCart do
  @moduledoc """
  ...
  alias Ashworld.Catalog
  alias Ashworld.ShoppingCart.{Cart, CartItem}
  ...
  ## Examples
      ...
      iex> add_item_to_cart(cart, product_id)
      {:ok, %CartItem{}}

      iex> add_item_to_cart(cart, bad_product_id)
      {:error, %Ecto.Changeset{}}
  """
  ...
  ## Examples
      ...
      iex> remove_item_from_cart(cart, product_id)
      {:ok, %Cart{}}

      iex> remove_item_from_cart(cart, bad_product_id)
      {:error, %Ecto.Changeset{}}
  """
  ...
  alias Ashworld.ShoppingCart.CartItem
