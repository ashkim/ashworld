defmodule Ashworld.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Ashworld.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Ashworld.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Ashworld.ShoppingCart.create_cart_item()
